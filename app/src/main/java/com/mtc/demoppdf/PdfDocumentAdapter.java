...
public class PdfDocumentAdapter extends PrintDocumentAdapter {
    ...
    @Override
    public void onLayout(PrintAttributes oldAttributes, PrintAttributes printAttributes1,
        ...
        builder.setContentType(PrintDocumentInfo.CONTENT_TYPE_DOCUMENT)
                ...
                .build();
        layoutResultCallback.onLayoutFinished(builder.build(), !oldAttributes.equals(printAttributes1));
