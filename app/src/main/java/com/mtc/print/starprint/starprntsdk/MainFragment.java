...
//                intentForPassingData.putExtra(CommonActivity.BUNDLE_KEY_LANGUAGE, PrinterSettingConstant.LANGUAGE_ENGLISH);
//                CommonAlertDialogFragment.Callback mCallbackTarget = (CommonAlertDialogFragment.Callback) getParentFragment();
//                onDialogResult(PRINTER_LANG_SELECT_DIALOG, intentForPassingData);
...
//                Intent intent = new Intent(getActivity(), CommonActivity.class);
                ...
                intent.putExtra(CommonActivity.BUNDLE_KEY_LANGUAGE,  PrinterSettingConstant.LANGUAGE_ENGLISH);
                intent.putExtra(CommonActivity.BUNDLE_KEY_SHOW_HOME_BUTTON, true);
...
//    }
    ...
    private void updateList() {
        ...
        int modelIndex = ModelCapability.MC_PRINT3;
        String modelName = "";
        ...
        addMenu("Print Receipt", isDeviceSelected);
...
//        addMenu("Library Version");
    ...
    private void addPrinterInfo(List<PrinterSettings> settingsList) {
        if (settingsList.size() == 0) {
            ...
            adapter.add(new ItemList(R.layout.list_main_row, mainTextList, ContextCompat.getColor(getActivity(), R.color.purple_200), true));
        } else {
            ...
            adapter.add(new ItemList(R.layout.list_destination_device_row, textList, ContextCompat.getColor(getActivity(), R.color.purple_200), true));
        }
    }
}
