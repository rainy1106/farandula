...
//          case PrinterSettingConstant.LANGUAGE_CJK_UNIFIED_IDEOGRAPH:
            default:
                localizeReceipts = new Utf8MultiLanguageReceiptsImpl();
                break;
        }
...
//          case PrinterSettingConstant.PAPER_SIZE_FOUR_INCH :
    ...
    public void appendTextReceiptData(Bitmap icon, ICommandBuilder builder, boolean utf8) {
        switch (mPaperSize) {
            case PrinterSettingConstant.PAPER_SIZE_TWO_INCH:
                append2inchTextReceiptData(icon,builder, utf8);
                break;
            case PrinterSettingConstant.PAPER_SIZE_THREE_INCH:
...
//          case PrinterSettingConstant.PAPER_SIZE_DOT_THREE_INCH:
    ...
    public abstract void append2inchTextReceiptData(Bitmap icon, ICommandBuilder builder, boolean utf8);
