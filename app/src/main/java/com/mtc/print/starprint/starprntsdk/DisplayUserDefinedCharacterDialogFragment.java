...
public class DisplayUserDefinedCharacterDialogFragment extends CommonAlertDialogFragment {
    ...
    public static DisplayUserDefinedCharacterDialogFragment newInstance(String tag) {
        DisplayUserDefinedCharacterDialogFragment dialogFragment = new DisplayUserDefinedCharacterDialogFragment();
    ...
    private DialogInterface.OnClickListener mOnSetResetClickListener = new DialogInterface.OnClickListener() {
        @Override
