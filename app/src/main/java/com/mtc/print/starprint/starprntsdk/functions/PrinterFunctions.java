...
public class PrinterFunctions {
    ...
    public static byte[] createTextReceiptData(Bitmap icon, Emulation emulation, ILocalizeReceipts localizeReceipts, boolean utf8) {
        ICommandBuilder builder = StarIoExt.createCommandBuilder(emulation);

        builder.beginDocument();

        localizeReceipts.appendTextReceiptData(icon,builder, utf8);
