...
public class AutomaticPageLengthTypeSelectDialogFragment extends CommonAlertDialogFragment {
    private Callback mCallbackTarget;

    public static AutomaticPageLengthTypeSelectDialogFragment newInstance(String tag) {
        AutomaticPageLengthTypeSelectDialogFragment dialogFragment = new AutomaticPageLengthTypeSelectDialogFragment();
    ...
    Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Select automatic page length type.");
    ...
    private DialogInterface.OnClickListener mOnTypeClickListener = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            intentForPassingData.putExtra(CommonActivity.BUNDLE_KEY_AUTOMATIC_PAGE_LENGTH_TYPE_INDEX, which);
