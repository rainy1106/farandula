...
//        }
    ...
    private void print(int selectedIndex) {
        ...
        switch (selectedIndex) {
            default:
            case 1:
                commands = PrinterFunctions.createTextReceiptData(icon,emulation, localizeReceipts, false);
                break;
            case 2:
                commands = PrinterFunctions.createTextReceiptData(icon, emulation, localizeReceipts, true);
                break;
            case 3:
