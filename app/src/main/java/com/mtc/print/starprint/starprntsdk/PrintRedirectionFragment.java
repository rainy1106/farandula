...
//
//import com.mtc.lottieanimationsexamples.R;
//
//import java.util.ArrayList;
//import java.util.List;
//
//import starprntsdk.functions.PrinterFunctions;
//import starprntsdk.localizereceipts.ILocalizeReceipts;
//
...
//
//            adapter.add(new ItemList(R.layout.list_main_row, mainTextList,
//                    ContextCompat.getColor(getActivity(), R.color.purple_200), true));
//        } else {
...
//        @Override
//        public void onStatus(List<Pair<String, Communication.CommunicationResult>> communicationResultList) {
//            if (!mIsForeground) {
//                return;
//            }
//
...
//                Pair<String, Communication.CommunicationResult> pair = communicationResultList.get(i);
//
