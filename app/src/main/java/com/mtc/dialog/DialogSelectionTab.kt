    ...
    class MyDialogResTabSeAdapter(
        ...
        class ItemViewHolder(itemView: View, val mEventHandler: EventHandler) :
            ...
            fun bindView(selectionClass: SelectionClass) {
                textView.text = selectionClass.table_name
                itemView.setOnClickListener {
                    SharedPreference.setTableId(itemView.context, selectionClass.table_id)
                    SharedPreference.setTableName(itemView.context,selectionClass.table_name)
                    mEventHandler.onSuccess("seats")
                }
            }
